...
export function TrailSlide({trail, showPhoto=true}) {
    let coordinates = {
        ...
        <Card className="trailSlide">
            <div className="container">
                <div class="half" > 
                    ...
                    <div style={{display:"flex"}}>
                        <Button className="map" danger type="primary" icon={<EnvironmentOutlined />} onClick={handleShow}>
                            Map
                        </Button>
                        {trail.url ? 
                            <Button type="primary" onClick={() => window.open(trail.url, '_blank')}>
                                More Info
                            </Button> 
                            : 
                            ""
            ...
            <>
                <Offcanvas style={{width: "500px"}}show={show} onHide={handleClose}>
                    ...
                    <Offcanvas.Body>
                        <MyMap coordinates = {coordinates} name = {trail.name}/>
                    </Offcanvas.Body>
                </Offcanvas>
            </>
        </Card>
